...
public class LruCache<K, V> {
    ...
    public final String toString() {
        ...
        synchronized (this) {
            ...
            if (n2 == 0) return String.format("LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", this.maxSize, this.hitCount, this.missCount, n);
    ...
    public void trimToSize(int n) {
        do {
            ...
            synchronized (this) {
                ...
                this.map.remove(k);
                this.size -= this.safeSizeOf(k, entry2);
                ++this.evictionCount;
            }
