...
lbl25: // 2 sources:
    ...
    public void ensureCapacity(int n) {
        if (this.mHashes.length < n) {
            ...
            this.allocArrays(n);
            if (this.mSize > 0) {
                System.arraycopy((Object)arrn, 0, (Object)this.mHashes, 0, this.mSize);
                System.arraycopy((Object)arrobject, 0, (Object)this.mArray, 0, this.mSize << 1);
            }
    ...
    public V put(K object, V v) {
        ...
        if (this.mSize >= this.mHashes.length) {
            ...
            if (this.mHashes.length > 0) {
                System.arraycopy((Object)arrn, 0, (Object)this.mHashes, 0, arrn.length);
                System.arraycopy((Object)arrobject, 0, (Object)this.mArray, 0, arrobject.length);
            }
            SimpleArrayMap.freeArrays(arrn, arrobject, this.mSize);
        }
        if (n4 < this.mSize) {
            System.arraycopy((Object)this.mHashes, n4, (Object)this.mHashes, n4 + 1, this.mSize - n4);
            System.arraycopy((Object)this.mArray, n4 << 1, (Object)this.mArray, n4 + 1 << 1, this.mSize - n4 << 1);
        }
        this.mHashes[n4] = n;
    ...
    public V removeAt(int n) {
        ...
        if (this.mHashes.length > 8 && this.mSize < this.mHashes.length / 3) {
            ...
            if (n > 0) {
                ...
                System.arraycopy((Object)arrobject, 0, (Object)this.mArray, 0, n << 1);
            }
            if (n >= this.mSize) return (V)object;
            {
                System.arraycopy((Object)arrn, n + 1, (Object)this.mHashes, n, this.mSize - n);
                System.arraycopy((Object)arrobject, n + 1 << 1, (Object)this.mArray, n << 1, this.mSize - n << 1);
                return (V)object;
            }
        }
        --this.mSize;
        if (n < this.mSize) {
            System.arraycopy((Object)this.mHashes, n + 1, (Object)this.mHashes, n, this.mSize - n);
            System.arraycopy((Object)this.mArray, n + 1 << 1, (Object)this.mArray, n << 1, this.mSize - n << 1);
        }
