...
public class GestureDetectorCompat {
    ...
    implements GestureDetectorCompatImpl {
        ...
        private boolean isConsideredDoubleTap(MotionEvent motionEvent, MotionEvent motionEvent2, MotionEvent motionEvent3) {
            int n;
            int n2;
            if (!this.mAlwaysInBiggerTapRegion || motionEvent3.getEventTime() - motionEvent2.getEventTime() > (long)DOUBLE_TAP_TIMEOUT || (n2 = (int)motionEvent.getX() - (int)motionEvent3.getX()) * n2 + (n = (int)motionEvent.getY() - (int)motionEvent3.getY()) * n >= this.mDoubleTapSlopSquare) {
                return false;
            }
            return true;
        }
