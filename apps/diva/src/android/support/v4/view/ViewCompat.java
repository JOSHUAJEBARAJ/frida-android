...
public class ViewCompat {
    ...
    static {
        ...
        IMPL = n >= 23 ? new MarshmallowViewCompatImpl() : (n >= 21 ? new LollipopViewCompatImpl() : (n >= 19 ? new KitKatViewCompatImpl() : (n >= 17 ? new JbMr1ViewCompatImpl() : (n >= 16 ? new JBViewCompatImpl() : (n >= 15 ? new ICSMr1ViewCompatImpl() : (n >= 14 ? new ICSViewCompatImpl() : (n >= 11 ? new HCViewCompatImpl() : (n >= 9 ? new GBViewCompatImpl() : (n >= 7 ? new EclairMr1ViewCompatImpl() : new BaseViewCompatImpl())))))))));
    }
    ...
    extends BaseViewCompatImpl {
        ...
        @Override
        public void setChildrenDrawingOrderEnabled(ViewGroup viewGroup, boolean bl) {
            ViewCompatEclairMr1.setChildrenDrawingOrderEnabled(viewGroup, bl);
        }
    }
