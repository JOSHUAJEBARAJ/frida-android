...
public class ViewGroupCompat {
    ...
    static {
        ...
        IMPL = n >= 21 ? new ViewGroupCompatLollipopImpl() : (n >= 18 ? new ViewGroupCompatJellybeanMR2Impl() : (n >= 14 ? new ViewGroupCompatIcsImpl() : (n >= 11 ? new ViewGroupCompatHCImpl() : new ViewGroupCompatStubImpl())));
    }
    ...
    extends ViewGroupCompatJellybeanMR2Impl {
        ...
        public void setTransitionGroup(ViewGroup viewGroup, boolean bl) {
            ViewGroupCompatLollipop.setTransitionGroup(viewGroup, bl);
        }
    }
