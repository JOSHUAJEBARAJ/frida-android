...
public class MotionEventCompat {
    ...
    public static float getAxisValue(MotionEvent motionEvent, int n) {
        return IMPL.getAxisValue(motionEvent, n);
    }

    public static float getAxisValue(MotionEvent motionEvent, int n, int n2) {
        return IMPL.getAxisValue(motionEvent, n, n2);
    }
    ...
    implements MotionEventVersionImpl {
        ...
        @Override
        public float getAxisValue(MotionEvent motionEvent, int n) {
            return 0.0f;
        }

        @Override
        public float getAxisValue(MotionEvent motionEvent, int n, int n2) {
            return 0.0f;
        }
