        ...
        switch (var6_2 & 255) {
            ...
            case 2: {
                if (!this.mIsBeingDragged) {
                    ...
                    var2_6 = MotionEventCompat.getX(var1_1, var6_2);
                    var4_7 = Math.abs(var2_6 - this.mLastMotionX);
                    var3_8 = MotionEventCompat.getY(var1_1, var6_2);
                    ...
                    if (var4_7 > (float)this.mTouchSlop && var4_7 > var5_9) {
                        ...
                        this.setScrollState(1);
                        this.setScrollingCacheEnabled(true);
                        var11_10 = this.getParent();
                        if (var11_10 != null) {
                            var11_10.requestDisallowInterceptTouchEvent(true);
                        }
                    }
                }
                var9_4 = var10_3;
                if (this.mIsBeingDragged) {
                    var9_4 = false | this.performDrag(MotionEventCompat.getX(var1_1, MotionEventCompat.findPointerIndex(var1_1, this.mActivePointerId)));
                    break;
                }
                ** GOTO lbl80
            }
            case 1: {
                var9_4 = var10_3;
                if (this.mIsBeingDragged) {
                    var11_11 = this.mVelocityTracker;
                    var11_11.computeCurrentVelocity(1000, (float)this.mMaximumVelocity);
                    var6_2 = (int)VelocityTrackerCompat.getXVelocity((VelocityTracker)var11_11, this.mActivePointerId);
                    this.mPopulatePending = true;
                    var7_12 = this.getClientWidth();
                    var8_13 = this.getScrollX();
                    var11_11 = this.infoForCurrentScrollPosition();
                    this.setCurrentItemInternal(this.determineTargetPage(var11_11.position, ((float)var8_13 / (float)var7_12 - var11_11.offset) / var11_11.widthFactor, var6_2, (int)(MotionEventCompat.getX(var1_1, MotionEventCompat.findPointerIndex(var1_1, this.mActivePointerId)) - this.mInitialMotionX)), true, true, var6_2);
                    var9_4 = this.resetTouch();
                    break;
                }
                ** GOTO lbl80
            ...
            case 5: {
                ...
                this.mLastMotionX = MotionEventCompat.getX(var1_1, var6_2);
                this.mActivePointerId = MotionEventCompat.getPointerId(var1_1, var6_2);
                var9_4 = var10_3;
            }
lbl80: // 5 sources:
            case 4: {
