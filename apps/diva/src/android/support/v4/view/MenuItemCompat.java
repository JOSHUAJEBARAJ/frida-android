...
public class MenuItemCompat {
    ...
    static {
        ...
        IMPL = n >= 14 ? new IcsMenuVersionImpl() : (n >= 11 ? new HoneycombMenuVersionImpl() : new BaseMenuVersionImpl());
    }
    ...
    public static MenuItem setActionView(MenuItem menuItem, int n) {
        if (menuItem instanceof SupportMenuItem) {
            return ((SupportMenuItem)menuItem).setActionView(n);
        }
        return IMPL.setActionView(menuItem, n);
    }
    ...
    public static void setShowAsAction(MenuItem menuItem, int n) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem)menuItem).setShowAsAction(n);
            return;
        }
        IMPL.setShowAsAction(menuItem, n);
    }
    ...
    implements MenuVersionImpl {
        ...
        @Override
        public MenuItem setActionView(MenuItem menuItem, int n) {
            return menuItem;
        }
        ...
        @Override
        public void setShowAsAction(MenuItem menuItem, int n) {
        }
    }
