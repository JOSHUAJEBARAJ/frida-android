...
public class BitmapCompat {
    ...
    static {
        ...
        IMPL = n >= 19 ? new KitKatBitmapCompatImpl() : (n >= 18 ? new JbMr2BitmapCompatImpl() : (n >= 12 ? new HcMr1BitmapCompatImpl() : new BaseBitmapImpl()));
    }
    ...
    extends HcMr1BitmapCompatImpl {
        ...
        @Override
        public void setHasMipMap(Bitmap bitmap, boolean bl) {
            BitmapCompatJellybeanMR2.setHasMipMap(bitmap, bl);
        }
    }
