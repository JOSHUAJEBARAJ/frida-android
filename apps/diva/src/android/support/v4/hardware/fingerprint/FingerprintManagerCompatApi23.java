...
public final class FingerprintManagerCompatApi23 {
    public static void authenticate(Context context, CryptoObject cryptoObject, int n, Object object, AuthenticationCallback authenticationCallback, Handler handler) {
        FingerprintManagerCompatApi23.getFingerprintManager(context).authenticate(FingerprintManagerCompatApi23.wrapCryptoObject(cryptoObject), (CancellationSignal)object, n, FingerprintManagerCompatApi23.wrapCallback(authenticationCallback), handler);
    }
