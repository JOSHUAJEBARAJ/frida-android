...
extends RemoteInputCompatBase.RemoteInput {
    ...
    static {
        ...
        FACTORY = new RemoteInputCompatBase.RemoteInput.Factory(){
            ...
            @Override
            public RemoteInput build(String string2, CharSequence charSequence, CharSequence[] arrcharSequence, boolean bl, Bundle bundle) {
                return new RemoteInput(string2, charSequence, arrcharSequence, bl, bundle);
            }
    ...
    RemoteInput(String string2, CharSequence charSequence, CharSequence[] arrcharSequence, boolean bl, Bundle bundle) {
        this.mResultKey = string2;
        this.mLabel = charSequence;
        this.mChoices = arrcharSequence;
        this.mAllowFreeFormInput = bl;
        this.mExtras = bundle;
    }
