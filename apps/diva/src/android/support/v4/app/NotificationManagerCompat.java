...
public class NotificationManagerCompat {
    ...
    public static Set<String> getEnabledListenerPackages(Context object) {
        if ((object = Settings.Secure.getString((ContentResolver)object.getContentResolver(), (String)"enabled_notification_listeners")) != null && !object.equals(sEnabledNotificationListeners)) {
            Object object2 = object.split(":");
            HashSet<String> hashSet = new HashSet<String>(object2.length);
            int n = object2.length;
            for (int i = 0; i < n; ++i) {
                ComponentName componentName = ComponentName.unflattenFromString((String)object2[i]);
    ...
    public void cancel(String string2, int n) {
        IMPL.cancelNotification(this.mNotificationManager, string2, n);
    ...
    public void notify(String string2, int n, Notification notification) {
        ...
        IMPL.postNotification(this.mNotificationManager, string2, n, notification);
    }
    ...
    implements Task {
        ...
        public CancelTask(String string2, int n, String string3) {
            this.packageName = string2;
            this.id = n;
            this.tag = string3;
            this.all = false;
    ...
    implements Impl {
        ...
        @Override
        public void cancelNotification(NotificationManager notificationManager, String string2, int n) {
        ...
        @Override
        public void postNotification(NotificationManager notificationManager, String string2, int n, Notification notification) {
    ...
    extends ImplBase {
        ...
        @Override
        public void cancelNotification(NotificationManager notificationManager, String string2, int n) {
            NotificationManagerCompatEclair.cancelNotification(notificationManager, string2, n);
        }

        @Override
        public void postNotification(NotificationManager notificationManager, String string2, int n, Notification notification) {
            NotificationManagerCompatEclair.postNotification(notificationManager, string2, n, notification);
        }
    }
    ...
    implements Task {
        ...
        public NotifyTask(String string2, int n, String string3, Notification notification) {
            this.packageName = string2;
            this.id = n;
            this.tag = string3;
...
lbl21: // 3 sources:
        ...
        private void scheduleListenerRetry(ListenerRecord listenerRecord) {
            ...
            if (Log.isLoggable((String)"NotifManCompat", (int)3)) {
                Log.d((String)"NotifManCompat", (String)("Scheduling retry for " + n + " ms"));
            }
        ...
        private void updateListenerMap() {
            ...
            if (!object.equals(this.mCachedEnabledPackages)) {
                ...
                while (object.hasNext()) {
                    ...
                    if (Log.isLoggable((String)"NotifManCompat", (int)3)) {
                        Log.d((String)"NotifManCompat", (String)("Removing listener record for " + (Object)componentName3.getKey()));
                    }
