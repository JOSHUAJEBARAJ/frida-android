...
public class AppOpsManagerCompat {
    ...
    public static int noteOp(@NonNull Context context, @NonNull String string2, int n, @NonNull String string3) {
        return IMPL.noteOp(context, string2, n, string3);
    }
    ...
    extends AppOpsManagerImpl {
        ...
        @Override
        public int noteOp(Context context, String string2, int n, String string3) {
            return AppOpsManagerCompat23.noteOp(context, string2, n, string3);
        }
