...
class PlaybackStateCompatApi21 {
    ...
    static final class CustomAction {
        ...
        public static Object newInstance(String string2, CharSequence charSequence, int n, Bundle bundle) {
            string2 = new PlaybackState.CustomAction.Builder(string2, charSequence, n);
