...
extends ViewGroup {
    ...
    void layoutHorizontal(int n, int n2, int n3, int n4) {
        ...
        switch (GravityCompat.getAbsoluteGravity(n2 & 8388615, ViewCompat.getLayoutDirection((View)this))) {
            default: {
...
lbl182: // 1 sources:
    ...
    public void setHorizontalGravity(int n) {
        if ((this.mGravity & 8388615) != (n &= 8388615)) {
            this.mGravity = this.mGravity & -8388616 | n;
            this.requestLayout();
        }
    }
    ...
    public void setVerticalGravity(int n) {
        if ((this.mGravity & 112) != (n &= 112)) {
            this.mGravity = this.mGravity & -113 | n;
            this.requestLayout();
        }
    }
