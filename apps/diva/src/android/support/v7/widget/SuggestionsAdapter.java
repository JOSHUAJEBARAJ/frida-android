...
implements View.OnClickListener {
    ...
    private Drawable getActivityIconWithCache(ComponentName componentName) {
        ...
        componentName = drawable2 == null ? null : drawable2.getConstantState();
...
lbl29: // 1 sources:
    ...
    public CharSequence convertToString(Cursor object) {
        ...
        String string3 = string2 = SuggestionsAdapter.getColumnString((Cursor)object, "suggest_intent_query");
        if (string2 != null) return string3;
        if (this.mSearchable.shouldRewriteQueryFromData() && (string3 = SuggestionsAdapter.getColumnString((Cursor)object, "suggest_intent_data")) != null) {
            return string3;
        }
