...
LayoutInflaterFactory {
     ...
     * Enabled aggressive block sorting
     */
    private void closePanel(PanelFeatureState panelFeatureState, boolean bl) {
    ...
    private ViewGroup createSubDecor() {
        Object object = this.mContext.obtainStyledAttributes(R.styleable.Theme);
        if (!object.hasValue(R.styleable.Theme_windowActionBar)) {
            object.recycle();
            throw new IllegalStateException("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
        }
        if (object.getBoolean(R.styleable.Theme_windowNoTitle, false)) {
            this.requestWindowFeature(1);
        } else if (object.getBoolean(R.styleable.Theme_windowActionBar, false)) {
            this.requestWindowFeature(108);
        }
        if (object.getBoolean(R.styleable.Theme_windowActionBarOverlay, false)) {
            this.requestWindowFeature(109);
        }
        if (object.getBoolean(R.styleable.Theme_windowActionModeOverlay, false)) {
            this.requestWindowFeature(10);
        }
        this.mIsFloating = object.getBoolean(R.styleable.Theme_android_windowIsFloating, false);
        object.recycle();
        ...
        if (!this.mWindowNoTitle) {
            if (this.mIsFloating) {
                ...
                layoutInflater = (ViewGroup)LayoutInflater.from((Context)object).inflate(R.layout.abc_screen_toolbar, null);
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ViewCompat.setOnApplyWindowInsetsListener((View)object, new OnApplyWindowInsetsListener(){
                    ...
                    public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                        ...
                        int n2 = AppCompatDelegateImplV7.this.updateStatusGuard(n);
        ...
        layoutInflater = (ViewGroup)this.mWindow.findViewById(16908290);
    ...
    private void doInvalidatePanelMenu(int n) {
     ...
     * Enabled aggressive block sorting
     */
    private PanelFeatureState findMenuPanel(Menu menu2) {
    ...
    private PanelFeatureState getPanelState(int var1_1, boolean var2_2) {
        ...
        if (var4_3.length <= var1_1) lbl-1000: // 2 sources:
        {
            ...
            if (var4_3 != null) {
                System.arraycopy((Object)var4_3, 0, var5_5, 0, var4_3.length);
            }
            var3_4 = var5_5;
            this.mPanels = var5_5;
        }
    ...
    private boolean onKeyUpPanel(int n, KeyEvent keyEvent) {
        ...
        boolean bl3 = false;
        PanelFeatureState panelFeatureState = this.getPanelState(n, true);
        if (n == 0 && this.mDecorContentParent != null && this.mDecorContentParent.canShowOverflowMenu() && !ViewConfigurationCompat.hasPermanentMenuKey(ViewConfiguration.get((Context)this.mContext))) {
    ...
    private void openPanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        if (panelFeatureState.featureId == 0) {
            ...
            n = (context.getResources().getConfiguration().screenLayout & 15) == 4 ? 1 : 0;
    ...
    private boolean preparePanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        int n = panelFeatureState.featureId == 0 || panelFeatureState.featureId == 108 ? 1 : 0;
     ...
     * Lifted jumps to return sites
     */
    private boolean shouldInheritContext(ViewParent var1_1) {
        var2_2 = var1_1;
...
lbl5: // 2 sources:
            ...
            if (var2_2 == this.mWindowDecor) return false;
            if (var2_2 instanceof View == false) return false;
            ** while (!ViewCompat.isAttachedToWindow((View)((View)var2_2)))
        }
lbl10: // 1 sources:
        return false;
    }
    ...
    public View createView(View var1_1, String var2_2, @NonNull Context var3_3, @NonNull AttributeSet var4_4) {
        ...
        {
            if (this.mSubDecorInstalled && this.shouldInheritContext((ViewParent)var1_1)) {
                var6_6 = true;
    ...
    public boolean hasWindowFeature(int n) {
        ...
        switch (n) {
            default: {
                return this.mWindow.hasFeature(n);
            }
            case 108: {
    ...
    boolean onKeyShortcut(int n, KeyEvent keyEvent) {
        ...
        if (object != null && object.onKeyShortcut(n, keyEvent)) return true;
     ...
     */
    @Override
    ActionMode startSupportActionModeFromWindow(ActionMode.Callback var1_1) {
        this.endOnGoingFadeAnimation();
        if (this.mActionMode != null) {
            this.mActionMode.finish();
        }
        var6_2 = new ActionModeCallbackWrapperV7(var1_1);
        var4_4 = var5_3 = null;
        if (this.mAppCompatCallback == null) ** GOTO lbl-1000
        var4_4 = var5_3;
        if (!this.isDestroyed()) {
            try {
                var4_4 = this.mAppCompatCallback.onWindowStartingSupportActionMode(var6_2);
            }
        ...
        if (var4_4 != null) {
            this.mActionMode = var4_4;
        } else lbl-1000: // 2 sources:
        {
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    var5_3 = new TypedValue();
                    var4_4 = this.mContext.getTheme();
                    var4_4.resolveAttribute(R.attr.actionBarTheme, (TypedValue)var5_3, true);
                    if (var5_3.resourceId != 0) {
                        var7_6 = this.mContext.getResources().newTheme();
                        var7_6.setTo((Resources.Theme)var4_4);
                        var7_6.applyStyle(var5_3.resourceId, true);
                        var4_4 = new ContextThemeWrapper(this.mContext, 0);
                        var4_4.getTheme().setTo(var7_6);
                    } else {
                        var4_4 = this.mContext;
                    }
                    this.mActionModeView = new ActionBarContextView((Context)var4_4);
                    this.mActionModePopup = new PopupWindow((Context)var4_4, null, R.attr.actionModePopupWindowStyle);
                    PopupWindowCompat.setWindowLayoutType(this.mActionModePopup, 2);
                    this.mActionModePopup.setContentView((View)this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    var4_4.getTheme().resolveAttribute(R.attr.actionBarSize, (TypedValue)var5_3, true);
                    var2_7 = TypedValue.complexToDimensionPixelSize((int)var5_3.data, (DisplayMetrics)var4_4.getResources().getDisplayMetrics());
                    this.mActionModeView.setContentHeight(var2_7);
                    ...
                    var4_4 = (ViewStubCompat)this.mSubDecor.findViewById(R.id.action_mode_bar_stub);
                    if (var4_4 != null) {
                        var4_4.setLayoutInflater(LayoutInflater.from((Context)this.getActionBarThemedContext()));
                        this.mActionModeView = (ActionBarContextView)var4_4.inflate();
                    }
                }
            }
            if (this.mActionModeView != null) {
                ...
                var4_4 = this.mActionModeView.getContext();
                var5_3 = this.mActionModeView;
                var3_8 = this.mActionModePopup == null;
                if (var1_1.onCreateActionMode((ActionMode)(var4_4 = new StandaloneActionMode((Context)var4_4, (ActionBarContextView)var5_3, var6_2, var3_8)), var4_4.getMenu())) {
                    var4_4.invalidate();
                    this.mActionModeView.initForMode((ActionMode)var4_4);
                    this.mActionMode = var4_4;
    ...
    extends ContentFrameLayout {
        ...
        public boolean dispatchKeyEvent(KeyEvent keyEvent) {
            if (AppCompatDelegateImplV7.this.dispatchKeyEvent(keyEvent) || super.dispatchKeyEvent(keyEvent)) {
                return true;
            }
            return false;
        }
    ...
    implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(MenuBuilder object, boolean bl) {
            ...
            if ((object = appCompatDelegateImplV7.findMenuPanel((Menu)object)) != null) {
                if (!bl2) {
                    AppCompatDelegateImplV7.this.closePanel((PanelFeatureState)object, bl);
                    return;
                }
