...
extends ActionMode {
    ...
    implements ActionMode.Callback {
        ...
        private Menu getMenuWrapper(Menu menu2) {
            ...
            if (menu3 == null) {
                menu4 = MenuWrapperFactory.wrapSupportMenu(this.mContext, (SupportMenu)menu2);
                this.mMenus.put(menu2, menu4);
            }
            return menu4;
        }

        public ActionMode getActionModeWrapper(android.support.v7.view.ActionMode object) {
        ...
        @Override
        public boolean onCreateActionMode(android.support.v7.view.ActionMode actionMode, Menu menu2) {
        ...
        @Override
        public boolean onPrepareActionMode(android.support.v7.view.ActionMode actionMode, Menu menu2) {
