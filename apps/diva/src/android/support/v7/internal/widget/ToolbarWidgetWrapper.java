...
implements DecorToolbar {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean bl) {
        this(toolbar, bl, R.string.abc_action_bar_up_description, R.drawable.abc_ic_ab_back_mtrl_am_alpha);
    }
    ...
    public ToolbarWidgetWrapper(Toolbar object, boolean bl, int n, int n2) {
        ...
        if (bl) {
            ...
            int n3 = object.getResourceId(R.styleable.ActionBar_customNavigationLayout, 0);
            if (n3 != 0) {
        ...
        this.setDefaultNavigationIcon(this.mTintManager.getDrawable(n2));
    ...
    public void animateToVisibility(int n) {
        ViewPropertyAnimatorCompat viewPropertyAnimatorCompat = this.setupAnimatorToVisibility(n, 200);
    ...
    public void setIcon(int n) {
        Drawable drawable2 = n != 0 ? this.mTintManager.getDrawable(n) : null;
...
lbl12: // 4 sources:
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int n, long l) {
        ...
        f = 0.0f;
        return viewPropertyAnimatorCompat.alpha(f).setDuration(l).setListener(new );
    }
