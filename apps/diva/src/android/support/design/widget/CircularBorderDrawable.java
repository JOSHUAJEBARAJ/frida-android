...
extends Drawable {
    ...
    private Shader createGradientShader() {
        ...
        int n = ColorUtils.compositeColors(this.mTopOuterStrokeColor, this.mTintColor);
        int n2 = ColorUtils.compositeColors(this.mTopInnerStrokeColor, this.mTintColor);
        int n3 = ColorUtils.compositeColors(ColorUtils.setAlphaComponent(this.mTopInnerStrokeColor, 0), this.mTintColor);
        int n4 = ColorUtils.compositeColors(ColorUtils.setAlphaComponent(this.mBottomInnerStrokeColor, 0), this.mTintColor);
        int n5 = ColorUtils.compositeColors(this.mBottomInnerStrokeColor, this.mTintColor);
        int n6 = ColorUtils.compositeColors(this.mBottomOuterStrokeColor, this.mTintColor);
        float f2 = rect.top;
