    ...
    public boolean arrowScroll(int var1_1) {
        ...
        if (var7_2 == this) {
            ...
            if (var7_2 != null) {
                ...
                do {
                    var2_5 = var3_4;
                    if (!(var6_3 instanceof ViewGroup)) break;
                    if (var6_3 == this) {
                        var2_5 = 1;
                        break;
                    }
                ...
                if (var2_5 == 0) {
                    ...
                    var8_6.append(var7_2.getClass().getSimpleName());
                    var6_3 = var7_2.getParent();
                    while (var6_3 instanceof ViewGroup) {
                        var8_6.append(" => ");
                        var8_6.append(var6_3.getClass().getSimpleName());
                        var6_3 = var6_3.getParent();
                    }
                    var6_3 = new StringBuilder();
                    var6_3.append("arrowScroll tried to find focus based on non-child current focused view ");
                    var6_3.append(var8_6.toString());
                    Log.e((String)"ViewPager", (String)var6_3.toString());
                    var6_3 = null;
                }
            }
        }
        var5_7 = false;
        var4_8 = false;
        var7_2 = FocusFinder.getInstance().findNextFocus((ViewGroup)this, (View)var6_3, var1_1);
        if (var7_2 == null || var7_2 == var6_3) ** GOTO lbl46
        if (var1_1 == 17) {
            var2_5 = this.getChildRectInPagerCoordinates((Rect)this.mTempRect, (View)var7_2).left;
            var3_4 = this.getChildRectInPagerCoordinates((Rect)this.mTempRect, (View)var6_3).left;
            var4_8 = var6_3 != null && var2_5 >= var3_4 ? this.pageLeft() : var7_2.requestFocus();
        } else if (var1_1 == 66) {
            var2_5 = this.getChildRectInPagerCoordinates((Rect)this.mTempRect, (View)var7_2).left;
            var3_4 = this.getChildRectInPagerCoordinates((Rect)this.mTempRect, (View)var6_3).left;
            var4_8 = var6_3 != null && var2_5 <= var3_4 ? this.pageRight() : var7_2.requestFocus();
        }
        ** GOTO lbl53
lbl46: // 1 sources:
        if (var1_1 == 17 || var1_1 == 1) ** GOTO lbl52
        if (var1_1 == 66) ** GOTO lbl-1000
        var4_8 = var5_7;
        if (var1_1 == 2) lbl-1000: // 2 sources:
        {
            var4_8 = this.pageRight();
        }
        ** GOTO lbl53
lbl52: // 1 sources:
        var4_8 = this.pageLeft();
lbl53: // 4 sources:
        if (var4_8 == false) return var4_8;
        ...
        while (n5 < this.mItems.size()) {
            ...
            if (n9 == -1) {
                ...
                if (this.mCurItem == object.position) {
                    n6 = Math.max(0, Math.min(this.mCurItem, n - 1));
                    n2 = 1;
                    n8 = n5;
                    n7 = n9;
                }
    ...
    protected void onLayout(boolean bl, int n, int n2, int n3, int n4) {
        ...
        for (n5 = 0; n5 < n11; ++n5) {
            ...
            n6 = n + (int)((float)n7 * itemInfo.offset);
            if (layoutParams.needsMeasure) {
                layoutParams.needsMeasure = false;
                view.measure(View.MeasureSpec.makeMeasureSpec((int)((int)((float)n7 * layoutParams.widthFactor)), (int)1073741824), View.MeasureSpec.makeMeasureSpec((int)(n10 - n2 - n4), (int)1073741824));
            }
        ...
        for (int i = 0; i < n6; ++i) {
            ...
            if (view.getVisibility() != 8) {
                ...
                if (layoutParams != null && layoutParams.isDecor) {
                    ...
                    view.measure(View.MeasureSpec.makeMeasureSpec((int)n3, (int)n8), View.MeasureSpec.makeMeasureSpec((int)n7, (int)n10));
                    if (n9 != 0) {
    ...
    public boolean onTouchEvent(MotionEvent var1_1) {
        ...
        var9_4 = false;
        if ((var6_3 &= 255) == 0) ** GOTO lbl67
        if (var6_3 == 1) ** GOTO lbl55
        if (var6_3 == 2) ** GOTO lbl31
        if (var6_3 != 3) {
            if (var6_3 != 5) {
                if (var6_3 == 6) {
...
lbl75: // 7 sources:
    ...
    void populate(int n) {
        ...
        if (n5 == this.mExpectedAdapterCount) {
            ...
            do {
                ...
                if (object3.position >= this.mCurItem) {
                    object4 = itemInfo;
                    if (object3.position != this.mCurItem) break;
                    object4 = object3;
                    break;
                }
                ++n;
            ...
            if (itemInfo != null) {
                ...
                float f3 = 0.0f;
                int n8 = n - 1;
                object4 = n8 >= 0 ? this.mItems.get(n8) : null;
                int n9 = this.getClientWidth();
                if (n9 <= 0) {
                    f2 = 0.0f;
                } else {
                    f = itemInfo.widthFactor;
                    f2 = (float)this.getPaddingLeft() / (float)n9 + (2.0f - f);
                }
                object3 = object4;
                int n10 = n;
                    ...
                    if (f3 >= f2 && n7 < n4) {
                        ...
                        if (n7 == object3.position) {
                            ...
                            if (!object3.scrolling) {
                                ...
                                n2 = n8 - 1;
                                n = n10 - 1;
                                object4 = n2 >= 0 ? this.mItems.get(n2) : null;
                                f = f3;
                            }
                        }
                    } else if (object3 != null && n7 == object3.position) {
                        f = f3 + object3.widthFactor;
                        n2 = n8 - 1;
                        object4 = n2 >= 0 ? this.mItems.get(n2) : null;
                        n = n10;
                    } else {
                        f = f3 + this.addNewItem((int)n7, (int)(n8 + 1)).widthFactor;
                        n = n10 + 1;
                        object4 = n8 >= 0 ? this.mItems.get(n8) : null;
                        n2 = n8;
                    }
                ...
                n = n10 + 1;
                if (f < 2.0f) {
                    object4 = n < this.mItems.size() ? this.mItems.get(n) : null;
                    f2 = n9 <= 0 ? 0.0f : (float)this.getPaddingRight() / (float)n9 + 2.0f;
                    n2 = n4;
                    n8 = n3;
                    for (n7 = this.mCurItem + 1; n7 < n5; ++n7) {
                        if (f >= f2 && n7 > n6) {
                            if (object4 == null) break;
                            if (n7 != object4.position || object4.scrolling) continue;
                            this.mItems.remove(n);
                            this.mAdapter.destroyItem(this, n7, object4.object);
                            if (n < this.mItems.size()) {
                                object4 = this.mItems.get(n);
                                continue;
                            }
                            object4 = null;
                            continue;
                        }
                        if (object4 != null && n7 == object4.position) {
                            f += object4.widthFactor;
                            if (++n < this.mItems.size()) {
                                object4 = this.mItems.get(n);
                                continue;
                            }
                        ...
                        object4 = this.addNewItem(n7, n);
                        f += object4.widthFactor;
                        object4 = ++n < this.mItems.size() ? this.mItems.get(n) : null;
                    }
                }
                this.calculatePageOffsets(itemInfo, n10, (ItemInfo)object2);
            ...
            for (n = 0; n < n2; ++n) {
                ...
                object4 = (LayoutParams)object2.getLayoutParams();
                object4.childIndex = n;
                if (object4.isDecor || object4.widthFactor != 0.0f || (object2 = this.infoForChild((View)object2)) == null) continue;
                object4.widthFactor = object2.widthFactor;
                object4.position = object2.position;
            }
            this.sortChildDrawingOrder();
            if (this.hasFocus()) {
                object4 = this.findFocus();
                object4 = object4 != null ? this.infoForAnyChild((View)object4) : null;
                if (object4 == null || object4.position != this.mCurItem) {
                    for (n = 0; n < this.getChildCount(); ++n) {
                        object4 = this.getChildAt(n);
                        object2 = this.infoForChild((View)object4);
                        if (object2 == null || object2.position != this.mCurItem || !object4.requestFocus(2)) continue;
                        return;
                    }
                }
            }
        ...
        object2.append("The application's PagerAdapter changed the adapter's contents without calling PagerAdapter#notifyDataSetChanged! Expected adapter item count: ");
        object2.append(this.mExpectedAdapterCount);
        object2.append(", found: ");
        object2.append(n5);
        object2.append(" Pager id: ");
        object2.append((String)object);
        object2.append(" Pager class: ");
        object2.append(this.getClass());
        object2.append(" Problematic adapter: ");
        object2.append(this.mAdapter.getClass());
    ...
    public void setPageMarginDrawable(@Nullable Drawable drawable2) {
    ...
    public static interface OnPageChangeListener {
        ...
        public void onPageScrolled(int var1, float var2, @Px int var3);
