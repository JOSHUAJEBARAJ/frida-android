...
public final class CircularArray<E> {
    ...
    private void doubleCapacity() {
        ...
        if (n4 >= 0) {
            ...
            System.arraycopy(arrE, n2, (Object)arrobject, 0, n3);
            System.arraycopy(this.mElements, 0, (Object)arrobject, n3, this.mHead);
    ...
    public void addLast(E e) {
        ...
        int n = this.mTail;
        arrE[n] = e;
        this.mTail = this.mCapacityBitmask & n + 1;
    ...
    public void removeFromEnd(int n) {
        ...
        if (n <= this.size()) {
            ...
            if ((n -= n3) > 0) {
                ...
                for (n = n3 = this.mTail - n; n < this.mTail; ++n) {
