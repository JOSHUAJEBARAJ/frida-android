...
implements Cloneable {
    ...
    public void append(long l, E e) {
        ...
        if ((n = this.mSize) >= this.mKeys.length) {
            ...
            System.arraycopy((Object)arrl2, 0, (Object)arrl, 0, arrl2.length);
            arrl2 = this.mValues;
            System.arraycopy((Object)arrl2, 0, (Object)arrobject, 0, arrl2.length);
            this.mKeys = arrl;
    ...
    public void put(long l, E e) {
        ...
        if ((n2 = this.mSize) >= this.mKeys.length) {
            ...
            long[] arrl = this.mKeys;
            System.arraycopy((Object)arrl, 0, (Object)arrobject, 0, arrl.length);
            arrl = this.mValues;
            System.arraycopy((Object)arrl, 0, (Object)arrobject2, 0, arrl.length);
            this.mKeys = arrobject;
            this.mValues = arrobject2;
        }
        if ((n2 = this.mSize) - n != 0) {
            arrobject = this.mKeys;
            System.arraycopy((Object)arrobject, n, (Object)arrobject, n + 1, n2 - n);
            arrobject = this.mValues;
            System.arraycopy((Object)arrobject, n, (Object)arrobject, n + 1, this.mSize - n);
        }
        this.mKeys[n] = l;
        this.mValues[n] = e;
        ++this.mSize;
