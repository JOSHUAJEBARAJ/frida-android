...
implements Cloneable {
    ...
    public void append(int n, E e) {
        ...
        if ((n2 = this.mSize) >= this.mKeys.length) {
            ...
            arrn2 = this.mValues;
            System.arraycopy((Object)arrn2, 0, (Object)arrobject, 0, arrn2.length);
            this.mKeys = arrn;
    ...
    public void put(int n, E e) {
        ...
        if ((n3 = this.mSize) >= this.mKeys.length) {
            ...
            int[] arrn = this.mKeys;
            System.arraycopy((Object)arrn, 0, (Object)arrobject, 0, arrn.length);
            arrn = this.mValues;
            System.arraycopy((Object)arrn, 0, (Object)arrobject2, 0, arrn.length);
            this.mKeys = arrobject;
            this.mValues = arrobject2;
        }
        if ((n3 = this.mSize) - n2 != 0) {
            arrobject = this.mKeys;
            System.arraycopy((Object)arrobject, n2, (Object)arrobject, n2 + 1, n3 - n2);
            arrobject = this.mValues;
            System.arraycopy((Object)arrobject, n2, (Object)arrobject, n2 + 1, this.mSize - n2);
        }
        this.mKeys[n2] = n;
        this.mValues[n2] = e;
        ++this.mSize;
