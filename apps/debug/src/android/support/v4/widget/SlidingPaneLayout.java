...
extends ViewGroup {
    ...
    protected void onMeasure(int var1_1, int var2_2) {
        ...
        for (var10_5 = 0; var10_5 < var14_12; ++var10_5) {
            ...
            if (var18_18.getVisibility() != 8) ** GOTO lbl61
...
lbl84: // 3 sources:
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (n != 0) {
            ...
            if (this.isDimmed(this.mSlideableView) && (f4 = (f3 = motionEvent.getX()) - this.mInitialMotionX) * f4 + (f2 = (f = motionEvent.getY()) - this.mInitialMotionY) * f2 < (float)((n = this.mDragHelper.getTouchSlop()) * n) && this.mDragHelper.isViewUnder(this.mSlideableView, (int)f3, (int)f)) {
    ...
    public void setParallaxDistance(@Px int n) {
        this.mParallaxBy = n;
        this.requestLayout();
    }
    ...
    public void setShadowDrawableLeft(@Nullable Drawable drawable2) {
        this.mShadowDrawableLeft = drawable2;
    }

    public void setShadowDrawableRight(@Nullable Drawable drawable2) {
    ...
    void updateObscuredViewsVisibility(View view) {
        ...
        for (int i = 0; i < n10; ++i) {
            ...
            n11 = n12 >= n4 && n13 >= n && n11 <= n3 && n14 <= n2 ? 4 : 0;
