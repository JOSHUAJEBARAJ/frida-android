...
public class ViewDragHelper {
    ...
    private void ensureMotionHistorySizeForId(int n) {
        ...
        if (arrf == null || arrf.length <= n) {
            ...
            if (arrf5 != null) {
                System.arraycopy((Object)arrf5, 0, (Object)arrf, 0, arrf5.length);
                arrf5 = this.mInitialMotionY;
                System.arraycopy((Object)arrf5, 0, (Object)arrf2, 0, arrf5.length);
                arrf5 = this.mLastMotionX;
                System.arraycopy((Object)arrf5, 0, (Object)arrf3, 0, arrf5.length);
                arrf5 = this.mLastMotionY;
                System.arraycopy((Object)arrf5, 0, (Object)arrf4, 0, arrf5.length);
                arrf5 = this.mInitialEdgesTouched;
                System.arraycopy((Object)arrf5, 0, (Object)arrn, 0, arrf5.length);
                arrf5 = this.mEdgeDragsInProgress;
                System.arraycopy((Object)arrf5, 0, (Object)arrn2, 0, arrf5.length);
                arrf5 = this.mEdgeDragsLocked;
                System.arraycopy((Object)arrf5, 0, (Object)arrn3, 0, arrf5.length);
            }
    ...
    public boolean shouldInterceptTouchEvent(@NonNull MotionEvent var1_1) {
        var8_2 = var1_1.getActionMasked();
        var7_3 = var1_1.getActionIndex();
        if (var8_2 == 0) {
            this.cancel();
        }
        if (this.mVelocityTracker == null) {
        ...
        if (var8_2 == 0) ** GOTO lbl35
        if (var8_2 == 1) ** GOTO lbl33
        if (var8_2 == 2) ** GOTO lbl30
        if (var8_2 == 3) ** GOTO lbl33
        if (var8_2 != 5) {
            if (var8_2 == 6) {
                this.clearMotionHistory(var1_1.getPointerId(var7_3));
            }
        } else {
            var6_4 = var1_1.getPointerId(var7_3);
            var2_7 = var1_1.getX(var7_3);
            var3_10 = var1_1.getY(var7_3);
            this.saveInitialMotion(var2_7, var3_10, var6_4);
            var7_3 = this.mDragState;
            if (var7_3 == 0) {
                var7_3 = this.mInitialEdgesTouched[var6_4];
                var8_2 = this.mTrackingEdges;
                if ((var7_3 & var8_2) != 0) {
                    this.mCallback.onEdgeTouched(var8_2 & var7_3, var6_4);
                }
            } else if (var7_3 == 2 && (var1_1 = this.findTopChildUnder((int)var2_7, (int)var3_10)) == this.mCapturedView) {
                this.tryCaptureViewForDrag((View)var1_1, var6_4);
            }
        }
        ** GOTO lbl68
lbl30: // 1 sources:
        if (this.mInitialMotionX == null || this.mInitialMotionY == null) ** GOTO lbl68
        var6_5 = var1_1.getPointerCount();
        ** GOTO lbl45
lbl33: // 2 sources:
        this.cancel();
        ** GOTO lbl68
lbl35: // 1 sources:
        var2_9 = var1_1.getX();
        var3_12 = var1_1.getY();
        var6_6 = var1_1.getPointerId(0);
        this.saveInitialMotion(var2_9, var3_12, var6_6);
        var1_1 = this.findTopChildUnder((int)var2_9, (int)var3_12);
        if (var1_1 == this.mCapturedView && this.mDragState == 2) {
            this.tryCaptureViewForDrag((View)var1_1, var6_6);
        }
        if (((var7_3 = this.mInitialEdgesTouched[var6_6]) & (var8_2 = this.mTrackingEdges)) != 0) {
            this.mCallback.onEdgeTouched(var8_2 & var7_3, var6_6);
        }
        ** GOTO lbl68
lbl45: // 3 sources:
        for (var9_13 = 0; var9_13 < var6_5; ++var9_13) {
            var11_17 = var1_1.getPointerId(var9_13);
            if (!this.isValidPointerForActionMove(var11_17)) continue;
            var2_8 = var1_1.getX(var9_13);
            var3_11 = var1_1.getY(var9_13);
            var4_14 = var2_8 - this.mInitialMotionX[var11_17];
            var5_15 = var3_11 - this.mInitialMotionY[var11_17];
            var18_24 = this.findTopChildUnder((int)var2_8, (int)var3_11);
            var10_16 = var18_24 != null && this.checkTouchSlop(var18_24, var4_14, var5_15) != false;
            if (var10_16) {
                var12_18 = var18_24.getLeft();
                var13_19 = (int)var4_14;
                var13_19 = this.mCallback.clampViewPositionHorizontal(var18_24, var13_19 + var12_18, (int)var4_14);
                var14_20 = var18_24.getTop();
                var15_21 = (int)var5_15;
                var15_21 = this.mCallback.clampViewPositionVertical(var18_24, var15_21 + var14_20, (int)var5_15);
                var16_22 = this.mCallback.getViewHorizontalDragRange(var18_24);
                var17_23 = this.mCallback.getViewVerticalDragRange(var18_24);
                if ((var16_22 == 0 || var16_22 > 0 && var13_19 == var12_18) && (var17_23 == 0 || var17_23 > 0 && var15_21 == var14_20)) break;
            }
            this.reportNewEdgeDrags(var4_14, var5_15, var11_17);
            if (this.mDragState == 1 || var10_16 && this.tryCaptureViewForDrag(var18_24, var11_17)) break;
        }
        this.saveLastMotion(var1_1);
lbl68: // 7 sources:
        if (this.mDragState != 1) return false;
        return true;
    }
    ...
    public static abstract class Callback {
        ...
        public void onViewPositionChanged(@NonNull View view, int n, int n2, @Px int n3, @Px int n4) {
        }
