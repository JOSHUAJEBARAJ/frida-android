...
NestedScrollingChild {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (!this.isEnabled() || this.mReturningToStart || this.canChildScrollUp() || this.mRefreshing) return false;
    ...
    public void setSlingshotDistance(@Px int n) {
    ...
    public static interface OnChildScrollUpCallback {
        public boolean canChildScrollUp(@NonNull SwipeRefreshLayout var1, @Nullable View var2);
    }
