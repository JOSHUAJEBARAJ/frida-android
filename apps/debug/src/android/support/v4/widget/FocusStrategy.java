...
class FocusStrategy {
    ...
    private static boolean beamsOverlap(int var0, @NonNull Rect var1_1, @NonNull Rect var2_2) {
        if (var0 == 17) ** GOTO lbl8
        if (var0 == 33) ** GOTO lbl5
        if (var0 != 66) {
            if (var0 != 130) throw new IllegalArgumentException("direction must be one of {FOCUS_UP, FOCUS_DOWN, FOCUS_LEFT, FOCUS_RIGHT}.");
lbl5: // 2 sources:
            if (var2_2.right < var1_1.left) return false;
            if (var2_2.left > var1_1.right) return false;
            return true;
        }
lbl8: // 3 sources:
        if (var2_2.bottom < var1_1.top) return false;
        if (var2_2.top > var1_1.bottom) return false;
        return true;
    }
