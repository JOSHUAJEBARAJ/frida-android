...
final class GradientColorInflaterCompat {
    ...
    private static ColorStops checkColors(@Nullable ColorStops colorStops, @ColorInt int n, @ColorInt int n2, boolean bl, @ColorInt int n3) {
        if (colorStops != null) {
            return colorStops;
        }
        if (bl) {
    ...
    static Shader createFromXmlInner(@NonNull Resources object, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws IOException, XmlPullParserException {
    ...
    private static ColorStops inflateChildElements(@NonNull Resources object, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        int n;
        int n2;
        ...
        while ((n2 = xmlPullParser.next()) != 1 && ((n = xmlPullParser.getDepth()) >= n3 || n2 != 3)) {
            ...
            object = new StringBuilder();
            object.append(xmlPullParser.getPositionDescription());
            object.append(": <item> tag requires a 'color' attribute and a 'offset' ");
    ...
    static final class ColorStops {
        ...
        ColorStops(@ColorInt int n, @ColorInt int n2) {
            this.mColors = new int[]{n, n2};
            this.mOffsets = new float[]{0.0f, 1.0f};
        }

        ColorStops(@ColorInt int n, @ColorInt int n2, @ColorInt int n3) {
