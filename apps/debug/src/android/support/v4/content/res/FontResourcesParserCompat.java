...
public class FontResourcesParserCompat {
     ...
     */
    public static List<List<byte[]>> readCerts(Resources list, @ArrayRes int n) {
    ...
    public static final class FontFileResourceEntry {
        ...
        public FontFileResourceEntry(@NonNull String string2, int n, boolean bl, @Nullable String string3, int n2, int n3) {
