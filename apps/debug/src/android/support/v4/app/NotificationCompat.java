...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            if (bitmap != null) {
                ...
                d2 = bitmap.getHeight();
                Double.isNaN(d2);
                return Bitmap.createScaledBitmap((Bitmap)bitmap, (int)n, (int)((int)Math.ceil(d2 * d)), (boolean)true);
            }
            return bitmap;
        }
        ...
        public Builder setStyle(Style style2) {
            if (this.mStyle != style2 && (style2 = (this.mStyle = style2)) != null) {
    ...
    extends Style {
        ...
        private CharSequence makeMessageLine(Message object) {
            ...
            object = object.getText() == null ? string2 : object.getText();
        ...
        public static final class Message {
            ...
            public Message(CharSequence charSequence, long l, @Nullable Person person) {
