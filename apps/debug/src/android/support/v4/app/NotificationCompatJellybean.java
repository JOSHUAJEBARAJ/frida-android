...
class NotificationCompatJellybean {
    ...
    public static NotificationCompat.Action readAction(int n, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle) {
        ...
        if (bundle != null) {
            ...
            arrremoteInput = NotificationCompatJellybean.fromBundleArray(NotificationCompatJellybean.getBundleArrayFromBundle(bundle, "android.support.dataRemoteInputs"));
        ...
        return new NotificationCompat.Action(n, charSequence, pendingIntent, bundle, arrremoteInput2, arrremoteInput, bl, 0, true);
    }
