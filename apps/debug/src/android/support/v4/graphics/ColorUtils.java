...
public final class ColorUtils {
    ...
    public static void RGBToLAB(@IntRange(from=0, to=255) int n, @IntRange(from=0, to=255) int n2, @IntRange(from=0, to=255) int n3, @NonNull double[] arrd) {
        ColorUtils.RGBToXYZ(n, n2, n3, arrd);
        ColorUtils.XYZToLAB(arrd[0], arrd[1], arrd[2], arrd);
    }

    public static void RGBToXYZ(@IntRange(from=0, to=255) int n, @IntRange(from=0, to=255) int n2, @IntRange(from=0, to=255) int n3, @NonNull double[] arrd) {
        if (arrd.length == 3) {
            double d = n;
            Double.isNaN(d);
    ...
    public static Color compositeColors(@NonNull Color object, @NonNull Color color2) {
        if (Objects.equals((Object)object.getModel(), (Object)color2.getModel())) {
            if (!Objects.equals((Object)color2.getColorSpace(), (Object)object.getColorSpace())) {
                object = object.convert(color2.getColorSpace());
            }
            float[] arrf = object.getComponents();
            float[] arrf2 = color2.getComponents();
            float f = object.alpha();
            float f2 = color2.alpha() * (1.0f - f);
            int n = color2.getComponentCount() - 1;
            arrf2[n] = f + f2;
            float f3 = f;
            float f4 = f2;
            if (arrf2[n] > 0.0f) {
            ...
            return Color.valueOf((float[])arrf2, (ColorSpace)color2.getColorSpace());
        }
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Color models must match (");
        stringBuilder.append((Object)object.getModel());
