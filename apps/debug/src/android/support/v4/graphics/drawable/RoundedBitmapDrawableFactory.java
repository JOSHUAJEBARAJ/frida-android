...
public final class RoundedBitmapDrawableFactory {
    ...
    @NonNull
    public static RoundedBitmapDrawable create(@NonNull Resources object, @NonNull InputStream inputStream) {
    ...
    @NonNull
    public static RoundedBitmapDrawable create(@NonNull Resources object, @NonNull String string2) {
