    ...
    static float[] copyOfRange(float[] arrf, int n, int n2) {
        if (n <= n2) {
            ...
            if (n >= 0 && n <= n3) {
                ...
                System.arraycopy((Object)arrf, n, (Object)arrf2, 0, n3);
                return arrf2;
            }
...
lbl10: // 3 sources:
    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] arrf, char c, char c2, float[] arrf2) {
            ...
            while (c < arrf2.length) {
                ...
                if (c2 != 'A') {
                            ...
                            if (c2 != 'Q') {
                                if (c2 != 'V') {
                                    if (c2 != 'a') {
                                                            ...
                                                            if (c2 != 'M') {
                                                                if (c2 != 'S') {
                                                                    if (c2 != 'T') {
                                                                        ...
                                                                        path.quadTo(f2, f, arrf2[c + '\u0000'], arrf2[c + '\u0001']);
                                                                        f5 = arrf2[c + '\u0000'];
                                                                        f6 = arrf2[c + '\u0001'];
                                                                        f8 = f;
                                                                        f = f2;
                                        ...
                                        bl2 = arrf2[c + 4] != 0.0f;
                                        c4 = c;
                                        PathDataNode.drawArc(path, f5, f6, f + f5, f2 + f6, f8, f7, f9, bl, bl2);
                                        f = f5 += arrf2[c4 + 5];
                                        f2 = f6 += arrf2[c4 + 6];
                                    }
                                } else {
                    ...
                    bl = arrf2[c4 + 3] != 0.0f;
                    bl2 = arrf2[c4 + 4] != 0.0f;
                    PathDataNode.drawArc(path, f5, f6, f, f2, f8, f7, f9, bl, bl2);
                    f5 = arrf2[c4 + 5];
                    f6 = arrf2[c4 + 6];
                    f = f5;
                    f2 = f6;
        ...
        private static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean bl, boolean bl2) {
            ...
            d11 = Math.atan2(d7 - d5, d4 - d6);
            d7 = Math.atan2(d9 - d5, d8 - d6) - d11;
            bl = d7 >= 0.0;
            d4 = d7;
            if (bl2 != bl) {
                d4 = d7 > 0.0 ? d7 - 6.283185307179586 : d7 + 6.283185307179586;
            }
            d7 = f5;
            Double.isNaN(d7);
            d7 = f6;
            Double.isNaN(d7);
            d5 = d7 * d5;
            PathDataNode.arcToBezier(path, d6 * d2 - d5 * d3, (d6 *= d7) * d3 + d5 * d2, f5, f6, f, f2, d, d11, d4);
        }
