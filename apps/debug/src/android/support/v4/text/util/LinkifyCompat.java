...
import android.support.v4.text.util.FindAddress;
...
public final class LinkifyCompat {
    ...
    public static void addLinks(@NonNull TextView textView, @NonNull Pattern pattern, @Nullable String string2) {
    ...
    public static void addLinks(@NonNull TextView textView, @NonNull Pattern pattern, @Nullable String string2, @Nullable Linkify.MatchFilter matchFilter, @Nullable Linkify.TransformFilter transformFilter) {
        if (LinkifyCompat.shouldAddLinksFallbackToFramework()) {
    ...
    public static void addLinks(@NonNull TextView textView, @NonNull Pattern pattern, @Nullable String string2, @Nullable String[] arrstring, @Nullable Linkify.MatchFilter matchFilter, @Nullable Linkify.TransformFilter transformFilter) {
        if (LinkifyCompat.shouldAddLinksFallbackToFramework()) {
    ...
    public static boolean addLinks(@NonNull Spannable spannable, @NonNull Pattern pattern, @Nullable String string2) {
        if (LinkifyCompat.shouldAddLinksFallbackToFramework()) {
    ...
    public static boolean addLinks(@NonNull Spannable spannable, @NonNull Pattern pattern, @Nullable String string2, @Nullable Linkify.MatchFilter matchFilter, @Nullable Linkify.TransformFilter transformFilter) {
        if (LinkifyCompat.shouldAddLinksFallbackToFramework()) {
    ...
    public static boolean addLinks(@NonNull Spannable spannable, @NonNull Pattern object, @Nullable String arrstring, @Nullable String[] object2, @Nullable Linkify.MatchFilter matchFilter, @Nullable Linkify.TransformFilter transformFilter) {
        ...
        block7 : {
            ...
            if (object2 != null) {
                arrstring = object2;
                if (object2.length >= 1) break block7;
            }
