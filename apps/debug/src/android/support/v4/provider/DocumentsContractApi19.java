...
class DocumentsContractApi19 {
    ...
    public static boolean isVirtual(Context context, Uri uri) {
        ...
        if ((DocumentsContractApi19.getFlags(context, uri) & 512) != 0) {
            bl2 = true;
        }
        return bl2;
    }
     ...
     */
    @Nullable
    private static String queryForString(Context context, Uri uri, String charSequence, @Nullable String string2) {
        Throwable throwable222;
        Uri uri2;
        block4 : {
            ContentResolver contentResolver = context.getContentResolver();
