        ...
        if (n6 == Integer.MIN_VALUE) {
            ...
            if (typedValue != null) {
                ...
                if (typedValue.type != 0) {
                    ...
                    n9 = n;
                    if (n3 > 0) {
                        n9 = View.MeasureSpec.makeMeasureSpec((int)Math.min(n3 - (this.mDecorPadding.left + this.mDecorPadding.right), View.MeasureSpec.getSize((int)n)), (int)1073741824);
                        n8 = 1;
                    }
                }
            }
        ...
        if (n7 == Integer.MIN_VALUE) {
            ...
            if (typedValue != null) {
                ...
                if (typedValue.type != 0) {
                    ...
                    n3 = n2;
                    if (n > 0) {
                        n3 = View.MeasureSpec.makeMeasureSpec((int)Math.min(n - (this.mDecorPadding.top + this.mDecorPadding.bottom), View.MeasureSpec.getSize((int)n2)), (int)1073741824);
                    }
                }
            }
        }
        super.onMeasure(n9, n3);
        n7 = this.getMeasuredWidth();
        n9 = 0;
        n4 = View.MeasureSpec.makeMeasureSpec((int)n7, (int)1073741824);
        n2 = n9;
        n = n4;
        if (n8 == 0) {
            n2 = n9;
