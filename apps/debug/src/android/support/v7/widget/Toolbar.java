...
extends ViewGroup {
    ...
    protected void onLayout(boolean bl, int n, int n2, int n3, int n4) {
        ...
        if (!bl && !bl2) {
            ...
            if (n != 48) {
                if (n != 80) {
                    n = (n7 - n10 - n11 - n13) / 2;
                    if (n < layoutParams.topMargin + this.mTitleMarginTop) {
                        n = layoutParams.topMargin + this.mTitleMarginTop;
                    } else if ((n13 = n7 - n11 - n13 - n - n10) < layoutParams.bottomMargin + this.mTitleMarginBottom) {
                        n = Math.max(0, n - (object.bottomMargin + this.mTitleMarginBottom - n13));
                    }
                    n = n10 + n;
                } else {
            ...
            if (n5 != 0) {
                ...
                if (bl) {
                    layoutParams = (LayoutParams)this.mTitleTextView.getLayoutParams();
                    n7 = n5 - this.mTitleTextView.getMeasuredWidth();
                    n10 = this.mTitleTextView.getMeasuredHeight() + n;
                    this.mTitleTextView.layout(n7, n, n5, n10);
                    n = n7 - this.mTitleMarginEnd;
                ...
                if (bl2) {
                    layoutParams = (LayoutParams)this.mSubtitleTextView.getLayoutParams();
                    n5 = n10 + layoutParams.topMargin;
                    n10 = this.mSubtitleTextView.getMeasuredWidth();
                    n7 = this.mSubtitleTextView.getMeasuredHeight() + n5;
                    this.mSubtitleTextView.layout(n4 - n10, n5, n4, n7);
                ...
                if (bl) {
                    layoutParams = (LayoutParams)this.mTitleTextView.getLayoutParams();
                    n7 = this.mTitleTextView.getMeasuredWidth() + n13;
                    n10 = this.mTitleTextView.getMeasuredHeight() + n;
                    this.mTitleTextView.layout(n13, n, n7, n10);
                    n13 = n7 + this.mTitleMarginEnd;
                    n10 += layoutParams.bottomMargin;
                } else {
                    n10 = n;
                }
                ...
                if (bl2) {
                    layoutParams = (LayoutParams)this.mSubtitleTextView.getLayoutParams();
                    n2 = n10 + layoutParams.topMargin;
                    n10 = this.mSubtitleTextView.getMeasuredWidth() + n5;
                    n7 = this.mSubtitleTextView.getMeasuredHeight() + n2;
                    this.mSubtitleTextView.layout(n5, n2, n10, n7);
                    n7 = n10 + this.mTitleMarginEnd;
        ...
        n3 = n;
        for (n = 0; n < n2; ++n) {
            n3 = this.layoutChildLeft(this.mTempViews.get(n), n3, arrn, n4);
        }
    ...
    protected void onMeasure(int n, int n2) {
        ...
        if (this.shouldLayout((View)this.mMenuView)) {
            ...
            n6 = View.combineMeasuredStates((int)n9, (int)this.mMenuView.getMeasuredState());
            n9 = n7 + n4;
        } else {
            n6 = n9;
            n9 = 0;
        ...
        if (this.shouldLayout(this.mExpandedActionView)) {
            ...
            n6 = View.combineMeasuredStates((int)n6, (int)this.mExpandedActionView.getMeasuredState());
        } else {
            n5 = n8;
        }
        n3 = n7;
        ...
        n8 = n6;
        if (this.shouldLayout((View)this.mLogoView)) {
            n3 = n7 + this.measureChildCollapseMargins((View)this.mLogoView, n, n7, n2, 0, arrn);
            n4 = Math.max(n5, this.mLogoView.getMeasuredHeight() + this.getVerticalMargins((View)this.mLogoView));
            n8 = View.combineMeasuredStates((int)n6, (int)this.mLogoView.getMeasuredState());
        }
        ...
        if (this.shouldLayout((View)this.mTitleTextView)) {
            this.measureChildCollapseMargins((View)this.mTitleTextView, n, n3 + n10, n2, n4, arrn);
            n7 = this.mTitleTextView.getMeasuredWidth() + this.getHorizontalMargins((View)this.mTitleTextView);
            n5 = this.mTitleTextView.getMeasuredHeight() + this.getVerticalMargins((View)this.mTitleTextView);
            n6 = View.combineMeasuredStates((int)n8, (int)this.mTitleTextView.getMeasuredState());
        }
        if (this.shouldLayout((View)this.mSubtitleTextView)) {
            n7 = Math.max(n7, this.measureChildCollapseMargins((View)this.mSubtitleTextView, n, n3 + n10, n2, n5 + n4, arrn));
            n8 = this.mSubtitleTextView.getMeasuredHeight();
            n4 = this.getVerticalMargins((View)this.mSubtitleTextView);
        ...
        n7 = View.resolveSizeAndState((int)Math.max(n3 + n7 + (n4 + n10), this.getSuggestedMinimumWidth()), (int)n, (int)(-16777216 & n6));
        n = View.resolveSizeAndState((int)Math.max(n9 + (n8 + n5), this.getSuggestedMinimumHeight()), (int)n2, (int)(n6 << 16));
    ...
    public void setSubtitle(CharSequence charSequence) {
        ...
        if (!TextUtils.isEmpty((CharSequence)charSequence)) {
            if (this.mSubtitleTextView == null) {
                ...
                this.mSubtitleTextView = new AppCompatTextView((Context)textView);
    ...
    public void setTitle(CharSequence charSequence) {
        ...
        if (!TextUtils.isEmpty((CharSequence)charSequence)) {
            if (this.mTitleTextView == null) {
                textView = this.getContext();
                this.mTitleTextView = new AppCompatTextView((Context)textView);
    ...
    implements MenuPresenter {
        ...
        public boolean collapseItemActionView(MenuBuilder object, MenuItemImpl menuItemImpl) {
            ...
            object = Toolbar.this;
            object.mExpandedActionView = null;
            object.addChildrenForExpandedActionView();
