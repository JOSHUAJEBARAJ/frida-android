...
extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet object, int n) {
        ...
        resources = this.mThumbDrawable;
        if (resources != null) {
            resources.setCallback((Drawable.Callback)this);
        }
        this.mTrackDrawable = object.getDrawable(R.styleable.SwitchCompat_track);
        resources = this.mTrackDrawable;
        if (resources != null) {
            resources.setCallback((Drawable.Callback)this);
        }
    ...
    protected void onLayout(boolean bl, int n, int n2, int n3, int n4) {
        ...
        if (n != 16) {
            ...
            n2 = (this.getPaddingTop() + this.getHeight() - this.getPaddingBottom()) / 2;
            n = this.mSwitchHeight;
            n = (n2 -= n / 2) + n;
        }
        this.mSwitchLeft = n3;
        this.mSwitchTop = n2;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (n != 0) {
            if (n != 1) {
                if (n != 2) {
                    ...
                    if (Math.abs(f - this.mTouchX) <= (float)this.mTouchSlop && Math.abs(f4 - this.mTouchY) <= (float)this.mTouchSlop) return super.onTouchEvent(motionEvent);
                    this.mTouchMode = 2;
        ...
        if (!this.isEnabled() || !this.hitThumb(f, f5)) return super.onTouchEvent(motionEvent);
        this.mTouchMode = 1;
        this.mTouchX = f;
        this.mTouchY = f5;
        return super.onTouchEvent(motionEvent);
