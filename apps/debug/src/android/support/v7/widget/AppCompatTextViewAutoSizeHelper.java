...
class AppCompatTextViewAutoSizeHelper {
    ...
    private boolean suggestedSizeFitsInSpace(int n, RectF rectF) {
        ...
        charSequence = this.mTempTextPaint;
        ...
        charSequence = Build.VERSION.SDK_INT >= 23 ? this.createStaticLayoutForMeasuring((CharSequence)object2, (Layout.Alignment)charSequence, Math.round(rectF.right), n2) : this.createStaticLayoutForMeasuringPre23((CharSequence)object2, (Layout.Alignment)charSequence, Math.round(rectF.right));
