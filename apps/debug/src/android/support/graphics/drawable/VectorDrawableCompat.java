...
extends VectorDrawableCommon {
    ...
    private void inflateInternal(Resources var1_1, XmlPullParser var2_2, AttributeSet var3_3, Resources.Theme var4_4) throws XmlPullParserException, IOException {
        ...
        while (var7_9 != 1 && (var2_2.getDepth() >= var8_10 + 1 || var7_9 != 3)) {
            if (var7_9 != 2) ** GOTO lbl41
            var13_13 = var2_2.getName();
            var12_12 = (VGroup)var11_8.peek();
            if (!"path".equals(var13_13)) ** GOTO lbl21
            ...
            ** GOTO lbl47
lbl21: // 1 sources:
            if (!"clip-path".equals(var13_13)) ** GOTO lbl29
...
lbl47: // 8 sources:
    ...
    protected boolean onStateChange(int[] arrn) {
        ...
        if (vectorDrawableCompatState.isStateful()) {
            bl = bl2;
            if (vectorDrawableCompatState.onStateChanged(arrn)) {
                this.invalidateSelf();
                bl = true;
            }
        }
    ...
    extends VPath {
        ...
        public boolean onStateChanged(int[] arrn) {
            return this.mFillColor.onStateChanged(arrn) | this.mStrokeColor.onStateChanged(arrn);
        }
    ...
    extends VObject {
        ...
        public VGroup(VGroup vObject, ArrayMap<String, Object> arrayMap) {
            ...
            while (n < object.size()) {
                ...
                if (e instanceof VGroup) {
                    VGroup vGroup = (VGroup)e;
                    this.mChildren.add(new VGroup(vGroup, (ArrayMap<String, Object>)var2_9));
                } else {
                    void var1_7;
                    if (e instanceof VFullPath) {
                        VFullPath vFullPath = new VFullPath((VFullPath)e);
                    } else {
                        if (!(e instanceof VClipPath)) throw new IllegalStateException("Unknown object in the tree!");
                        VClipPath vClipPath = new VClipPath((VClipPath)e);
                    }
                    this.mChildren.add((VObject)var1_7);
                    if (var1_7.mPathName != null) {
                        var2_9.put(var1_7.mPathName, var1_7);
                    }
                }
                ++n;
            }
        ...
        public boolean onStateChanged(int[] arrn) {
            boolean bl = false;
            for (int i = 0; i < this.mChildren.size(); ++i) {
                bl |= this.mChildren.get(i).onStateChanged(arrn);
            }
            return bl;
        }
    ...
    private static class VPathRenderer {
        ...
        private void drawPath(VGroup object, VPath vPath, Canvas canvas, int n, int n2, ColorFilter colorFilter) {
            ...
            object = object.mStackedMatrix;
            this.mFinalPathMatrix.set((Matrix)object);
            this.mFinalPathMatrix.postScale(f, f2);
            f = this.getMatrixScale((Matrix)object);
            if (f == 0.0f) {
                return;
            }
            ...
            if (vPath.isClipPath()) {
                this.mRenderPath.addPath((Path)object, this.mFinalPathMatrix);
            ...
            if (vPath.mTrimPathStart != 0.0f || vPath.mTrimPathEnd != 1.0f) {
                ...
                object.reset();
                if (f4 > f6) {
                    this.mPathMeasure.getSegment(f4, f2, (Path)object, true);
                    this.mPathMeasure.getSegment(0.0f, f6, (Path)object, true);
                } else {
                    this.mPathMeasure.getSegment(f4, f6, (Path)object, true);
                }
                object.rLineTo(0.0f, 0.0f);
            }
            this.mRenderPath.addPath((Path)object, this.mFinalPathMatrix);
            if (vPath.mFillColor.willDraw()) {
                object = vPath.mFillColor;
                if (this.mFillPaint == null) {
                    this.mFillPaint = new Paint(1);
                    this.mFillPaint.setStyle(Paint.Style.FILL);
                }
                complexColorCompat = this.mFillPaint;
                if (object.isGradient()) {
                    object = object.getShader();
                    object.setLocalMatrix(this.mFinalPathMatrix);
                    complexColorCompat.setShader((Shader)object);
                    complexColorCompat.setAlpha(Math.round(vPath.mFillAlpha * 255.0f));
                } else {
                    complexColorCompat.setColor(VectorDrawableCompat.applyAlpha(object.getColor(), vPath.mFillAlpha));
                }
                complexColorCompat.setColorFilter(colorFilter);
                ...
                canvas.drawPath(this.mRenderPath, (Paint)complexColorCompat);
            }
            if (vPath.mStrokeColor.willDraw()) {
                complexColorCompat = vPath.mStrokeColor;
                ...
                if (vPath.mStrokeLineJoin != null) {
                    object.setStrokeJoin(vPath.mStrokeLineJoin);
                }
                if (vPath.mStrokeLineCap != null) {
                    object.setStrokeCap(vPath.mStrokeLineCap);
                }
                object.setStrokeMiter(vPath.mStrokeMiterlimit);
                if (complexColorCompat.isGradient()) {
                    complexColorCompat = complexColorCompat.getShader();
                    complexColorCompat.setLocalMatrix(this.mFinalPathMatrix);
                    object.setShader((Shader)complexColorCompat);
                    object.setAlpha(Math.round(vPath.mStrokeAlpha * 255.0f));
                } else {
                    object.setColor(VectorDrawableCompat.applyAlpha(complexColorCompat.getColor(), vPath.mStrokeAlpha));
                }
                object.setColorFilter(colorFilter);
                object.setStrokeWidth(vPath.mStrokeWidth * (f3 * f));
